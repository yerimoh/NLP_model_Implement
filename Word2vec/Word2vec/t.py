...
def main():
    ...
    #Training section
    W_emb, W_out = word2vec_trainer(fin_processed, word2ind, mode=mode, dimension=50, learning_rate=0.025, iteration=10000)
