...
if __name__ == '__main__':
    ...
    if part=="part":
        ...
        #for i in file_names:
        #    text = open('data_/'+i,mode='r').readlines()[0] #Load full corpus for submissionl
        ######
        f = open("fin_data",'a')
        count = 0
        for i in file_names:
    ...
    #Training section
    emb,_ = word2vec_trainer(processed, word2ind, mode=mode, dimension=50, learning_rate=0.025, iteration=50000)
